...
namespace App\Http\Livewire\Pages\Icon\Academy\Admin\DaftarPeserta\Components;
...
class ModalDetail extends ModalComponent
{
    ...
    {
        return view('livewire.pages.icon.academy.admin.daftar-peserta.components.modal-detail');
    }
