...
class ModaAddEdit extends ModalComponent
{
    public $promo;
    public $type = 'add';
    public $nama_promo = '';
    ...
    public function submit()
    {
        ...
        if ($this->type == 'add') {
            $this->validate([
                'kode_promo' => 'required|unique:promo_codes,promo_code'
            ]);
            PromoCode::create([
    ...
    {
        return view('livewire.pages.bionix.admin.promo.components.moda-add-edit');
    }
}
