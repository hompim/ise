...
<li><p><b>IS Class</b>, Simulasi perkuliahan yang memberikan kamu, para siswa/i SMA/SMK/sederajat, pengalaman menjadi seorang mahasiswa Sistem Informasi ITS. Dapatkan informasi seputar keilmuan dan keprofesian, serta rasakan langsung dunia perkuliahan bersama dosen-dosen terbaik di bidangnya.</p></li>
</ol>';
...
<b>One Aim, One Goal, One ISE!</b> </p>';
        return $this->subject('Pendaftaran Webinar Kick Off ISE! 2022 Berhasil!')->from('admin@ise-its.com', config('app.name'))->markdown(
