...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'divide-x divide-gray-100 text-sm text-white bg-gray-700',
            'odd' => 'divide-x divide-gray-100 text-sm text-white bg-gray-900',
            'selected' => 'divide-x divide-gray-100 text-sm text-white bg-purple-100',
        ],
        'cell' => 'whitespace-no-wrap text-sm text-white px-6 py-2',
    ],
];
