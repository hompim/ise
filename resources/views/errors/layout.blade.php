...
<div class="flex flex-col-reverse lg:flex-row items-center bg-black h-screen md:px-72 mx:0">
    <div class="flex flex-1 flex-col items-center lg:items-start text-white font-poppins">
        ...
        <a href="{{ app('router')->has('home') ? route('home') : url('/') }}">
            <button
                class="text-white font-bold uppercase tracking-wide py-3 px-8 hover:shadow-md rounded-lg mt-8 bg-gradient-to-r from-pink-300 to-purple-300 transition duration-300 hover:-translate-y-2">
                {{ __('Back To Home') }}
            </button>
        </a>
    </div>
