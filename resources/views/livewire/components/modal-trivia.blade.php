    ...
    <div id="defaultModal" aria-hidden="true"
        data-modal-show="{{ Auth::check() ? (Auth::user()->userable->hois_point > 0 ? 'false' : 'true') : 'true' }}"
            ...
            <div class="relative rounded-lg shadow bg-liteBlack">
                ...
                <div class="flex flex-col justify-center p-6 space-x-4 lg:flex-row">
                    ...
                    <div class="flex flex-col mt-4 text-center lg:text-start lg:mt-0">
                        ...
                        <p class="text-sm font-medium lg:!text-lg font-poppins text-liteGray">Hi, Metazen!<br><br>

                            Siapa yang sudah ikutan mencoba Quiz ISE! Trivia?<br><br>
                            Buat kalian yang belum, yuk cobain sekarang! Kalian bisa dapat hadiah-hadiah menarik cuman
                ...
                <div class="flex items-center p-6 space-x-2 rounded-b">
                    <div
                        ...
                        <a href="{{ route('quiz-ehall') }}" class="relative px-12 btn">To ISE! Trivia ></a>
                    </div>
                </div>
            </div>
        </div>
