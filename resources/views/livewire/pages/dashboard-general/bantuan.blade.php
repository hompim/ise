<div class="px-8">
    <h3 class="text-2xl font-weight-bold mb-4 text-white">Bantuan</h3>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="card rounded-xl" style=" background-color: #191a1e; border:0">
            <div class="card-body">
                <h3 class="text-xl font-weight-bold" style="color: rgb(178,33,229)">BIONIX</h3>
        ...
        <div class="card rounded-xl" style=" background-color: #191a1e; border:0">
            <div class="card-body">
                <h3 class="text-xl font-weight-bold" style="color: rgb(178,33,229)">ICON</h3>
                <h3 class="text-white text-lg my-1 font-weight-bold">Email</h3>
