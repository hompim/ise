<div class="px-8">
    ...
    <h3 class="text-xl font-weight-bold my-4 text-white">Grand Talkshow ISE! 2022</h3>
        ...
        <div class="card p-8 rounded-xl" style=" background-color: #191a1e; border:0">
            <div class="col-span-10 md:col-span-6">
                ...
                <div class="grid md:grid-cols-2 gap-4 grid-cols-1">
                    ...
                    <div>
                        <div>
                            <label for="team_name" class="mb-2 font-bold text-lg text-gray-300 ">Nama
                                Peserta</label><br>
                            <p class="font-bold text-white ">{{ Auth::user()->name }}</p>
                        </div>
                        <div>
                            <label for="Email" class="mb-2 font-bold text-lg text-gray-300  mt-4">Email
                                Peserta</label><br>
