<div class="px-8">
    ...
    <div class="card rounded-xl p-2" style="background-color: #191a1e; border:0">
        <div class="card-body">
            <div class="">
                <livewire:pages.icon.academy.admin.daftar-peserta.datatables.index model="App\Models\Icon\IconAcademyDataScienceData" />
            </div>
        </div>
    </div>
    ...
    <div class="card rounded-xl p-2" style="background-color: #191a1e; border:0">
        <div class="card-body">
            <div class="">
                <livewire:pages.icon.academy.admin.daftar-peserta.datatables.index model="App\Models\Icon\IconAcademyStartupData" />
            </div>
        </div>
    </div>
</div>
