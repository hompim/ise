<div class="px-8 text-white">
    ...
    <h3 class="text-xl font-weight-bold my-4">Soal Seleksi</h3>
            ...
            <div class="p-4 rounded-xl shadow-md" x-data="{ open: false }" style="background-color: #191a1e;border:0">
                <button class="w-full flex flex-col items-start" @click="open=!open">
                    <div class="flex flex-row items-center w-full justify-content-between">
                        <h2 class="font-bold text-xl  capitalize">Soal Seleksi Data Science Academy</h2>
                    ...
                    <div><i class="far fa-calendar-alt text-md mb-4 mr-2"></i><small
                            class="text-gray-300 font-medium text-base">Deadline
                            : 1 September 2022</small>
                    </div>
                </button>
                <div x-show="open">
                    <hr class="my-2" />
