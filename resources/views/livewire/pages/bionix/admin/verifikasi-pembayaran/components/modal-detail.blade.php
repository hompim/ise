<div class="p-4">
    ...
    <div class="px-4 mt-4">
        ...
        <div id="detail_pembayaran" class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class=" text-3xl font-bold">Rp {{number_format($bionix_data->payment_price,2,',','.')}}</p>
                </div>
            </div>
        </div>
        <hr class="my-4"/>
        ...
        <div class="flex flex-row justify-end">
            <button
                onclick="Livewire.emit('openModal', 'pages.bionix.admin.verifikasi-pembayaran.components.modal-accept-reject',{{json_encode(['type'=>$type,'modal_type'=>'reject','id'=>$bionix_data->id])}})"
