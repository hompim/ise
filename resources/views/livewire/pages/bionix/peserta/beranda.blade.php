            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="card shadow-md rounded-xl">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <div
                                class="text-gray-400">{{($is_junior?'Region':'Asal Daerah')}}</div>
                            <div
                                class="text-value-lg">{{$is_junior?'Region '.Auth::user()->userable->bionix->city->region:Auth::user()->userable->bionix->city->name}}</div>
                        </div>
                    </div>
                </div>
            </div>
