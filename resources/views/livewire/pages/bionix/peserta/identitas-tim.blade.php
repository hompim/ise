    ...
    <form wire:submit.prevent="saveData" enctype="multipart/form-data">
        <div class="card p-8 rounded-xl" style="background-color: #191a1e;border:0">
            <div
                ...
                <div id="informasi_tim" class="col-span-10 md:col-span-6">
                    ...
                    <div>
                        <label for="school_name"
                               class="mb-2 font-bold text-gray-400 mt-4">Asal {{$is_junior?'Sekolah':'Perguruan Tinggi'}}</label><br>
                        @if($is_edit)
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            @if(!$is_junior)
                                ...
                                <div>
                                    <label for="member_1_major" class="mb-2 font-bold text-gray-400 mt-4">Link Twibbon</label><br>
                                    @if($is_edit)
                                        <input wire:model.defer="member_1_twibbon" type="text" id="member_1_twibbon"
                                               name="member_1_twibbon"
                                               class="{{$readonly?'bg-gray-100':''}} registration-form input-text"
                ...
                @endif
                <div class="col-span-10 md:col-span-2"></div>
                @if(!$is_junior&&($member_3_name||$is_edit))
