...
<div class="bg-black pt-[50px] lg:pt-[200px] pb-[85px] lg:pb-[150px] text-center px-[22px] lg:px-[183px] tracking-wide " id="explore">
    ...
    dengan belajar langsung dari para expert dan memiliki kurikulum yang telah didesain secara ringkas untuk memberikan
    ...
    kepada para peserta sebagai the next founder of startup.
        ...
        <button title="Guidebook Available soon!" disabled
            ...
            <a href="#"
                        class=" py-2 my-6 rounded-full md:mx-0 mx-28 md:my-0 md:px-16 bg-gradient-to-r from-pink-300 to-purple-300 text-white">Register</a>
        </div>
...
<div class="flex flex-col sm:flex-row  mx-auto mb-[10px] mb-[200px] sm:gap-6 sm:justify-center font-poppins text-[#B5B3BC] gap-4 lg:gap-6 ">
    ...
    <div class=" bg-[#191A1E] px-[42px] pt-[32px] font-semibold text-[14px] lg:text-[18px] rounded-2xl w-[300px] lg:w-[380px] lg:h-[607px] ">
        ...
        Dengan mengikuti ISE! Startup Academy, aku dapat banyak sekali ilmu tentang bagaimana cara membangun startup yang baik oleh 
        <a class="text-[#BCA2F3]">speaker-speaker handal </a>maupun
        <a class="text-[#BCA2F3]">mentor yang berpengalaman. </a> Dari Startup Academy ini, kami mendapat kesempatan untuk 
        <a class="text-[#BCA2F3]">berkonsultasi langsung dengan para expertise-nya </a> sehingga dari arahan yang diberikan, kami 
        <a class="text-[#BCA2F3]">mengetahui bagaimana merealisasikan startup kami dari yang awalnya hanya sebatas ide saja.</a>
    </div>
    <!-- 2 -->
    <div class=" bg-[#191A1E] px-[42px] pt-[32px] font-semibold text-[14px] lg:text-[18px] rounded-2xl w-[300px] lg:w-[380px] lg:h-[607px] tracking-wide">
    <div class="flex flex-row gap-[11px] mb-[21px]">
            <div>
        ...
        Menjadi salah satu peserta terpilih ISE! Startup Academy memberikan pengalaman yang berharga buat saya. Saya banyak mendapatkan insight dan pengetahuan seputar teknologi dan dunia startup. Di sini saya 
        <a class="text-[#BCA2F3]">dibimbing oleh mentor-mentor yang berpengalaman untuk merealisasikan ide menjadi startup yang terstruktur.</a>  
        Selain itu, disini aku juga bisa 
        <a class="text-[#BCA2F3]">membangun koneksi dengan sesama startup enthusiast.</a>  So far, jadi peserta di ISE! Startup Academy 
...
{{-- Ini Cuma Background --}}
<div class="min-h-screeen bg-black py-52">
{{-- Ini Cuma Background --}}
