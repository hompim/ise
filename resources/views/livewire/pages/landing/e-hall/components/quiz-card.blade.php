    ...
    <div class="mt-32 md:mt-0 mb-[145px] bg-liteBlack mx-6 md:mx-28 h-max rounded-2xl flex flex-col p-[24px] md:p-11">
        ...
        <div class="flex flex-col md:flex-row mt-4 gap-14">
            ...
            <div class="flex flex-col">
                ...
                <p class="text-sm md:text-lg text-white mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Etiam eu turpis molestie, dictum
                ...
                <div class="flex flex-col md:flex-row mt-[24px] md:mt-[46px] mx-auto gap-[24px] md:gap-[74px] pl-0">
                    <div
                        class="w-[260px] md:w-[315px] h-[52px] md:h-[63px] bg-gradient-to-b from-[#B221E5] to-[#5B1BE1] rounded-lg ">
                        <!-- A.  Lorem ipsum -->
            ...
            <div class="flex flex-col mx-auto">
                <div class="grid grid-cols-2 gap-4 px-12 md:px-0  ">
                    @foreach ($quizzes as $quizNo => $quiz)
                        <button wire:click="moveQuestion({{ $quizNo - $currentQuiz }})" class="w-[56px] md:w-[75px] h-[56px] md:h-[75px] {{$currentQuiz == $quizNo+1 ? "bg-gradient-to-r from-[#B221E5] to-[#5B1BE1] text-white" : "bg-[#2F2F2F] text-white"}} mx-auto  text-2xl font-bold rounded-lg">{{$quizNo+1}}</button>
                    @endforeach
                </div>
                <button
                    class="mx-auto text-white md:text-xl rounded-lg col-span-2 btn px-8 md:px-10 py-2 mt-8 md:mt-100 font-semibold">Submit</button>
