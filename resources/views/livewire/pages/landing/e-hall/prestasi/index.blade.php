    ...
    <div class="flex flex-row pt-24 md:pt-52 mx-[20px] md:mx-[130px]">
        ...
        <div class="flex flex-col flex-1">
            ...
            <p class="text-sm md:text-lg text-liteGray mt-4 md:leading-normal text-left md:text-left">
                Prestasi merupakan Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan,risus sem sollicitudin lacus, ut interdum tellus elit sed risus  </p>
...
<!-- content 1-->
<div
    class="px-[20px] md:px-[130px] pt-[210px] pb-[120px] bg-black flex flex-col md:flex-row gap-[20px] md:gap-[120px]"
    id="explore">
    <!-- start : prestasi 1 -->
    <div class="md:w-[680px] md:h-[1260px] bg-[#191A1E] flex flex-col rounded-3xl">
        ...
        <div class="px-[27.95px]">
            ...
            <p class="text-[#B5B3BC] text-justify md:text-lg leading-[28px] font-normal tracking-normal">dolor sit amet, consecte adipis cing elit. Etiam eu turpis lestie, dictum esta, mattis tellus. Sed dignissim, metus nec fringilla orem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent auctor purus luctus enim egestas, ac scelerisque ante pulvinar. Donec ut rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem. Morbi convallis convallis diam sit amet lacinia. Aliquam in elementum tellus.</p>
        </div>
        <a
            href="#" >
            <button class="text-white px-[23px] py-[18px] bg-[#2F2F2F] rounded-2xl flex flex-row gap-[10px] md:w-[180px] font-semibold md:text-[20px] mx-auto md:mt-[150px]">
                Read more
    ...
    <div class="  flex flex-row md:flex-col gap-[20px] md:gap-[120px]">
        ...
        <div class="md:w-[380px] h-[570px] bg-[#191A1E] rounded-3xl">
            ...
            <a
                href="#" >
                <button class="text-white px-[23px] py-[18px] bg-[#2F2F2F] rounded-2xl flex flex-row gap-[10px] md:w-[180px] font-semibold  md:text-[20px] mx-auto md:mt-[20px]">
                    Read more
                    <img src="{{ asset('images/vector-logo.svg') }}" class="my-auto">
                </button>
            </a>
...
<!-- content 2-->
<div
    class="px-[20px] md:px-[130px] bg-black flex flex-col-reverse md:flex-row gap-[20px] md:gap-[120px]">
    <div class="  flex flex-row md:flex-col gap-[20px] md:gap-[120px]">
        <!-- start : prestasi 2 -->
        <div class="md:w-[380px] h-[570px] bg-[#191A1E] rounded-3xl">
            <img src="{{ asset('images/prestasi-2.svg') }}" class="w-full">
...
<!-- content 3-->
<div
    class="px-[20px] md:px-[130px] pt-[126px] pb-[120px] bg-black flex flex-col md:flex-row gap-[20px] md:gap-[120px]"
    id="explore">
    <!-- start : prestasi 1 -->
    <div class="md:w-[680px] md:h-[1260px] bg-[#191A1E] flex flex-col rounded-3xl">
        <img src="{{ asset('images/prestasi-1.svg') }}" class="w-full">
        ...
        <a
            href="#" >
            <button class="text-white px-[23px] py-[18px] bg-[#2F2F2F] rounded-2xl flex flex-row gap-[10px] md:w-[180px] font-semibold md:text-[20px] mx-auto mt-[150px]">
                Read more
                <img src="{{ asset('images/vector-logo.svg') }}" class="my-auto">
            </button>
        </a>
    ...
    <div id="default-carousel" class="relative px-[77px] lg:px-0 lg:h-[446px] lg:w-[752px] mx-auto "
            ...
            <div class="overflow-hidden relative bg-[#191A1E] block  mx-auto rounded-2xl  h-[255px] md:h-[446px]">
                ...
                <div class="absolute inset-0 z-20 flex flex-col items-center justify-center transition-all duration-700 ease-in-out transform translate-x-0"
                    data-carousel-item="">
                    <div>
                        <h1 class="text-transparent bg-clip-text bg-gradient-to-r from-[#5B1BE1] to-[#B221E5] font-bold text-xl md:text-3xl w-[60px] md:h-[60px] md:w-[94px] lg:h-[30px] mx-auto">2022</h1>
                ...
                <div class="duration-700 md:pt-[41px] ease-in-out absolute inset-0 transition-all transform translate-x-full z-10"
                    ...
                    <div>
                        <div>
                            <h1 class="text-transparent bg-clip-text bg-gradient-to-r from-[#5B1BE1] to-[#B221E5] font-bold text-xl md:text-3xl w-[60px] md:h-[60px] md:w-[94px] lg:h-[30px] mx-auto pt-10 md:pt-0">2021</h1>
                ...
                <div class="duration-700 md:pt-[51px] ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10"
                    data-carousel-item="">
                    <div>
                        <h1 class="text-transparent bg-clip-text bg-gradient-to-r from-[#5B1BE1] to-[#B221E5] font-bold md:text-3xl w-[60px] md:h-[60px] md:w-[94px] lg:h-[30px] mx-auto pt-10 md:pt-0">2020</h1>
                        <div class="px-[18px] md:px-[75px] pt-[10px] text-[8px] md:text-[20px]">
                            <p class="text-white pb-0 pt-[15px] md:pt-[37px] font-semibold ">
                                Juara 1 Lorem ipsum dolor consecte adipis cing elit. Etiam eu turpis lesti
                            </p>
                ...
                <div class="duration-700 md:pt-[51px] ease-in-out absolute inset-0 transition-all transform translate-x-full z-10"
                    data-carousel-item="">
                    <div>
                        <h1 class="text-transparent bg-clip-text bg-gradient-to-r from-[#5B1BE1] to-[#B221E5] font-bold md:text-3xl w-[60px] md:h-[60px] md:w-[94px] lg:h-[30px] mx-auto pt-10 md:pt-0">2019</h1>
                        <div class="px-[18px] md:px-[75px] pt-[10px] text-[8px] md:text-[20px]">
                            <p class="text-white pb-0 pt-[15px] md:pt-[37px] font-semibold ">
                                Juara 1 Lorem ipsum dolor consecte adipis cing elit. Etiam eu turpis lesti
                            </p>
