<div>
    ...
    <div class="min-h-screen bg-black font-poppins">
        ...
        <div class="px-[20px] md:px-[130px] pt-[210px] pb-[120px] bg-black grid grid-cols-3 gap-[20px] md:gap-[120px]"
            ...
            @foreach ($articles as $a)
                <div class="md:w-[380px] h-[570px] bg-[#191A1E] rounded-3xl">
                    ...
                    <div class="px-[15px]">
                        <h1 class="font-bold text-[26px] text-white pt-[19px] pb-[17px]" title="{{ $a->title }}">
                            {{ substr($a->title, 0, 24) . '...' }}
                        </h1>
