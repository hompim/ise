<div class="flex flex-col justify-center gap-8 text-center bg-black">
    ...
    <div class="lg:px-32 scroll-mt-24" id="bionix">
        ...
        <div class="flex flex-col-reverse justify-between lg:space-x-8 lg:flex-row">
            <div class="text-white text-left w-[350px] h-[420px] pl-6 pr-8 pt-12 bg-liteBlack rounded-3xl mx-8 mt-8">
    ...
    <div class="mt-24 lg:px-32 scroll-mt-24" id="icon">
        ...
        <div class="flex flex-col justify-between space-x-8 lg:flex-row">
    ...
    <div class="px-12 lg:px-56 my-36">
        ...
        <div class="relative group">
            ...
            <div class="relative flex flex-col items-center justify-center px-4 pb-24 rounded-md bg-liteBlack lg:px-28">
                <h3
                ...
                <p class="text-base font-medium lg:!text-lg font-poppins text-liteGray">Simulasi perkuliahan yang
                    memberikan kamu,
                    para siswa/i SMA/SMK/sederajat, pengalaman menjadi seorang mahasiswa Sistem Informasi ITS. Dapatkan
    ...
    <div class="pb-24 mx-12 lg:mx-32">
        <div class="px-4 py-12 rounded-md bg-liteBlack lg:px-52">
            <h1 class="text-4xl font-bold text-white lg:text-6xl font-poppins">Join us and <span
                    class="text-transparent bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text">get</span> a lot
                of <br> advantages.</h1>
            <div
