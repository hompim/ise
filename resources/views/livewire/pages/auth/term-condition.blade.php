...
<div class="flex items-center justify-center min-h-screen px-4 py-12 text-lg sm:px-6 lg:px-8"
    style="background: linear-gradient(116.52deg, #014167 -2.17%, #B45C5B 95.97%);">
    <div class="w-full max-w-5xl mb-10 space-y-8"
        ...
        <div>
            <h1 class="mx-5 text-5xl font-bold text-center capitalize">Terms and Conditions</h1>
        </div>
        <div class="mx-12" style="border: 1px solid rgba(0, 0, 0, 0); background: rgba(0, 0, 0, 0.21);">
        </div>
        <div id="terms-condition" class="px-12 pb-12 mx-12 leading-5 text-justify">
