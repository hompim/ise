...
<div class="flex items-center justify-center min-h-screen px-4 py-12 text-lg bg-black sm:px-6 lg:px-8">
    <div class="w-full max-w-5xl mb-10 space-y-8 bg-liteBlack">
        <div class="pt-6 pl-5 bg-right bg-no-repeat bg-cover sm:h-96 h-72"
            style="background-image: url({{ asset('img/auth/background-regis.svg') }})">
            <img alt="logo ISE ITS 2022" src="{{ asset('images/logo-ise.svg') }}">
        </div>
        <div>
            <h1 class="mx-5 text-5xl font-bold text-center text-white capitalize">Terms and Conditions</h1>
        </div>
        <div class="mx-12" style="border: 1px solid rgba(0, 0, 0, 0); background: rgba(0, 0, 0, 0.21);">
        </div>
        <div id="terms-condition" class="px-12 pb-12 mx-12 leading-5 text-justify text-white">
            <p>Welcome to Information System Expo ITS 2022!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Information System Expo ITS
                2022's Website, located at ise-its.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                Information System Expo ITS 2022 if you do not agree to take all of the terms and conditions stated on
                this page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                Our Terms and Conditions were created with the help of the <a
                    ...
                    Generator</a> and the <a href="https://www.generateprivacypolicy.com">Privacy Policy Generator</a>.
            </p>

            <h3><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing Information System Expo ITS 2022, you agreed to use cookies in
                agreement with the Information System Expo ITS 2022's Privacy Policy.</p>
            ...
            <p>Unless otherwise stated, Information System Expo ITS 2022 and/or its licensors own the intellectual
                property rights for all material on Information System Expo ITS 2022. All intellectual property rights
                are reserved. You may access this from Information System Expo ITS 2022 for your own personal use
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Information System Expo ITS 2022 does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not reflect the views and opinions of
                Information System Expo ITS 2022,its agents and/or affiliates. Comments reflect the views and opinions
                of the person who post their views and opinions. To the extent permitted by applicable laws, Information
                System Expo ITS 2022 shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                this website.</p>

            <p>Information System Expo ITS 2022 reserves the right to monitor all Comments and to remove any Comments
            ...
            <p>You hereby grant Information System Expo ITS 2022 a non-exclusive license to use, reproduce, edit and
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Information System Expo ITS 2022; and (d) the link is in the context of general resource
                information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Information System Expo ITS 2022. Please include
                your name, your organization name, contact information as well as the URL of your site, a list of any
                URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would
            ...
            <p>No use of Information System Expo ITS 2022's logo or other artwork will be allowed for linking absent a
