        ...
        <form  class="flex flex-col justify-center w-full px-4 mb-8 space-y-8 lg:mx-20"
            ...
            <div class="{{$step == 1 ? '' : "hidden"}}">
                @for ($x = 1; $x <= 3; $x++)
                    ...
                    {{-- anggota {{$x}} --}}
                    <h3 class="text-4xl mb-5 font-semibold text-white underline underline-offset-2 decoration-purple-200">{{ ($x == 1) ? "Ketua Tim" : "Anggota ".($x-1) }}
                    </h3>
                    <div class="flex flex-col my-11 space-y-2 font-medium text-white font-poppins">
                        <label for="member_{{$x}}_name">Nama Lengkap</label>
                        <input id="member_{{$x}}_name" name="member_{{$x}}_name" wire:model.defer ="member_{{$x}}_name" type="text" @if($x < 3) required @endif
                    ...
                    <div class="flex flex-col my-11 space-y-2 font-medium text-white font-poppins">
                        ...
                        <input id="member_{{$x}}_universitas" name="member_{{$x}}_universitas" wire:model.defer ="member_{{$x}}_universitas" type="text" @if($x < 3) required @endif
                            class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    ...
                    <div class="flex flex-col my-11 space-y-2 font-medium text-white font-poppins">
                        ...
                        <input id="ktm_{{$x}}" name="ktm_{{$x}}" wire:model.defer="ktm_{{$x}}" type="file" @if($x < 3) required @endif
                            ...
                            placeholder="Bukti Mahasiswa S1/Sederajat Aktif {{ ($x == 1) ? "Ketua Tim" : "Anggota ".($x-1) }}" accept=".jpg,.png">
                    </div>
                    <div class="flex flex-col my-11 space-y-2 font-medium text-white font-poppins">
                    ...
                    <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                        ...
                        <input id="member_{{$x}}_ig" name="member_{{$x}}_ig" wire:model.defer="member_{{$x}}_ig" type="text" @if($x < 3) required @endif
                            class=" rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    ...
                    <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                        ...
                        <input id="member_{{$x}}_twibbon" name="member_{{$x}}_twibbon" wire:model.defer="member_{{$x}}_twibbon" type="text" @if($x < 3) required @endif
                            class=" rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    ...
                    <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                        ...
                        <input id="member_{{$x}}_linkedin" name="member_{{$x}}_linkedin" wire:model.defer="member_{{$x}}_linkedin" type="text"
                            class=" rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    ...
                    <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                        ...
                        <input id="member_{{$x}}_twitter" name="member_{{$x}}_twitter" wire:model.defer="member_{{$x}}_twitter" type="text"
                            class=" rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                ...
                <div class="flex-row space-x-4 my-11 font-medium font-poppins">
                    <input type="checkbox" id="setuju_data_benar" name="setuju_data_benar" wire:model.defer="setuju_data_benar"
                        class="rounded-md cursor-pointer checked:bg-purple-200 checked:ring-purple-200 focus:ring-purple-200">
                    <label class="text-white" for="setuju_data_benar">  Dengan ini kami menyatakan semua data yang diisi benar dan bisa dipertanggungjawabkan</label>
                </div>
                <div class="relative left-0 right-0 justify-center mx-auto mt-24 text-center max-w-fit group">
                    <button type="button"
                        wire:click = "identityMemberSubmit()"
            ...
            <div class="{{$step == 2 ? null : "hidden"}}">
                ...
                <div class="flex flex-col my-12 space-y-2 font-medium text-white font-poppins">
                    ...
                    <input wire:model.defer = "judul_bisnis" id="judul" name="judul_bisnis" type="text" required
                        class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                ...
                <div class="flex flex-col my-12 space-y-2 font-medium text-white font-poppins">
                    ...
                    <input wire:model.defer = "deskripsi" id="deskripsi" name="deskripsi" type="text" required
                        class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                        placeholder="Masukkan deskripsi bisnis tim kamu">
                </div>

                <div class="flex-row space-x-4 my-11 font-medium font-poppins">
                    <input type="checkbox" id="setuju_ide_tim" name="setuju_ide_tim" wire:model.defer="setuju_ide_tim"
                        class="rounded-md cursor-pointer checked:bg-purple-200 checked:ring-purple-200 focus:ring-purple-200">
                    <label class="text-white" for="setuju_ide_tim">  Dengan ini saya bahwa ide bisnis kami belum pernah dilombakan maupun dijalankan sebelumnya</label>
                </div>
                <div class="relative left-0 right-0 justify-center mx-auto mt-24 text-center max-w-fit group">
                    <button type="button"
