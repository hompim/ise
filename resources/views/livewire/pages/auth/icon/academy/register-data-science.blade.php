    ...
    <div class="flex justify-center">
        <form  class="flex flex-col justify-center w-full px-4 mb-8 space-y-8 lg:mx-20"
            ...
            <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                ...
                <input wire:model.defer = "institution_name" id="institution_name" name="institution_name" type="text" required
                    class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    placeholder="Masukkan institusi kamu">
            </div>
            <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                <label for="alasan">Apa alasan tim Anda mengikuti Data Science Academy</label>
                <input wire:model.defer = "alasan" id="alasan" name="alasan" type="text" required
                    class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    placeholder="Masukkan apa alasan tim Anda">
            </div>
            <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                <label for="harapkan">Apa yang tim Anda harapkan dari Data Science Academy</label>
                <input wire:model.defer = "harapkan" id="harapkan" name="harapkan" type="text" required
                    class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    placeholder="Masukkan apa yang tim Anda harapkan">
            </div>
            <div class="flex flex-col space-y-2 my-11 font-medium text-white font-poppins">
                <label for="lakukan">Apa yang akan tim Anda lakukan pasca Data Science Academy</label>
                <input wire:model.defer = "lakukan" id="lakukan" name="lakukan" type="text" required
                    class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                    placeholder="Masukkan apa yang akan tim Anda lakukan">
            </div>
            ...
            @for ($x = 1; $x <= 3; $x++)
                ...
                {{-- anggota {{$x}} --}}
                <h3 class="text-4xl mb-5 font-semibold text-white underline underline-offset-2 decoration-purple-200">Anggota {{$x}}
                </h3>
                ...
                <div class="flex flex-col my-11 space-y-2 font-medium text-white font-poppins">
                    <label for="cv_{{$x}}">Curriculum Vitae (<=3Mb, .pdf)
                    </label>
                    <input id="cv_{{$x}}" name="cv_{{$x}}" wire:model.defer="cv_{{$x}}" type="file" @if($x < 3) required @endif
                        class=" rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  autofill:bg-transparent"
                        placeholder="Curriculum Vitae Anggota {{$x}}" accept="application/pdf">
                </div>
                {{-- anggota {{$x}} end --}}
