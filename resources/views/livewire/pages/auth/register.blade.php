                    ...
                    <div>
                        <label for="jenjang" class="block">
                            ...
                            <select name="jenjang" id=""
                                class="w-full p-2 bg-transparent rounded-md focus:outline-none autofill:bg-transparent focus:border-pink-200 focus:ring-pink-200">
                                <option value="" class="bg-liteBlack" selected disabled>Pilih Jenjangmu
                                </option>
                                <option value="Mahasiswa" class="bg-liteBlack">Mahasiswa</option>
                                <option value="SMA" class="bg-liteBlack">Siswa SMA</option>
                                <option value="Umum" class="bg-liteBlack">Umum</option>
                            </select>
                        </label>
                    </div>
                </div>
