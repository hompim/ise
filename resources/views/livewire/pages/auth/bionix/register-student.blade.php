        ...
        <form class="flex flex-col justify-center w-full px-4 mb-8 space-y-8 lg:mx-20" wire:submit.prevent="akunSubmit"
            ...
            <div class="{{ $step == 2 ? null : 'hidden' }}">
                ...
                <div class="kelas my-11">
                    ...
                    <div class="flex items-center mb-2">
                        <input id="kelas10" name="member_1_class" wire:model.defer="member_1_class" type="radio"
                            value="10" required
                    ...
                    <div class="flex items-center mb-2">
                        <input id="kelas12" name="member_1_class" wire:model.defer="member_1_class" type="radio"
                            value="12" required
                            class="p-2 bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  checked:bg-purple-200 cursor-pointer">
                        <label for="kelas12"
                            class="!mt-0 ml-2 font-light text-white font-poppins cursor-pointer">Kelas
                ...
                <div class="kelas my-11">
                    <h5 class="mb-4 text-lg text-white">Kelas</h5>
                    <div class="flex items-center mb-2">
                        <input id="kelas10" name="member_2_class" wire:model.defer="member_2_class" type="radio"
                            value="10"
                            class="p-2 bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  checked:bg-purple-200 cursor-pointer">
                        <label for="kelas10"
                            class="!mt-0 ml-2 font-light text-white font-poppins cursor-pointer">Kelas
                    ...
                    <div class="flex items-center mb-2">
                        <input id="kelas11" name="member_2_class" wire:model.defer="member_2_class" type="radio"
                            value="11"
                            class="p-2 bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  checked:bg-purple-200 cursor-pointer">
                        <label for="kelas11"
                            class="!mt-0 ml-2 font-light text-white font-poppins cursor-pointer">Kelas
                    ...
                    <div class="flex items-center mb-2">
                        <input id="kelas12" name="member_2_class" wire:model.defer="member_2_class" type="radio"
                            value="12"
                            class="p-2 bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  checked:bg-purple-200 cursor-pointer">
                        <label for="kelas12"
                            class="!mt-0 ml-2 font-light text-white font-poppins cursor-pointer">Kelas
            ...
            <div class="{{ $step == 3 ? null : 'hidden' }}">
                <div class="flex flex-col space-y-2 font-medium font-poppins">
                    ...
                    <select id="info-pendaftaran" name="info-pendaftaran" name="info_source"
                        wire:model.defer="info_source" required
                        class="p-2 rounded-md bg-transparent !border border-[#6B7280] focus-visible:!border-pink-200 focus:!border-pink-200 focus:!ring-pink-200  text-white">
