<div class="p-4">
    <div class="flex justify-between">
        ...
        <button type="button" title="Hapus" wire:click="$emit('closeModal')" class="self-start"><i
                class="cil-x"></i></button>
    </div>
    <hr/>
    <p class="text-lg mt-4">Apakah anda ingin menghapus shorten link <b>{{$this->link->shorten_link}}</b>?</p>
